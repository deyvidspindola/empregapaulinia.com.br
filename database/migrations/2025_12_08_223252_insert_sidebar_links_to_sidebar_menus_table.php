...
return new class extends Migration
{
    ...
    public function up(): void
    {
        DB::table('sidebar_menus')->insert([
            ...
            // employer links
            [ 'label' => 'Dashboard',        'icon' => 'la-tachometer-alt', 'route' => 'dashboard.dashboard',      'possition' => 1, 'role' => 'employer'],
            [ 'label' => 'Vagas',            'icon' => 'la-briefcase',       'route' => 'dashboard.vagas.index',          'possition' => 2, 'role' => 'employer'],
            [ 'label' => 'Candidatos',       'icon' => 'la-users',           'route' => 'dashboard.candidatos',     'possition' => 3, 'role' => 'employer'],
            [ 'label' => 'Carteira',         'icon' => 'la-wallet',          'route' => 'dashboard.carteira',       'possition' => 4, 'role' => 'employer'],
            [ 'label' => 'Planos',           'icon' => 'la-layer-group',     'route' => 'dashboard.planos',         'possition' => 5, 'role' => 'employer'],
            [ 'label' => 'Dados da Empresa', 'icon' => 'la-building',        'route' => 'dashboard.dados-da-empresa.index',  'possition' => 6, 'role' => 'employer'],
