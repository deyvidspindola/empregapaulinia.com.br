(function($) {
	...
	function formRegister() {
        const buttons = $('.btn-box .register-btn');
        const roleInput = $('#user-role');

        buttons.click(function() {

            if (buttons.hasClass('btn-style-seven')) {
                buttons.addClass('btn-style-four');
                buttons.removeClass('btn-style-seven');
            }
            
            // Adiciona a classe 'active' apenas no botão clicado
            $(this).addClass('btn-style-seven');
            
            // Atualiza o valor do input hidden com o valor do data-role do botão clicado
